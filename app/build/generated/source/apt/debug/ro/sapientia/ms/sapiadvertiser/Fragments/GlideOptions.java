...
public final class GlideOptions extends RequestOptions {
   ...
   */
  public static GlideOptions sizeMultiplierOf(float arg0) {
   ...
   */
  public static GlideOptions placeholderOf(int arg0) {
    return new GlideOptions().placeholder(arg0);
  }
   ...
   */
  public static GlideOptions errorOf(int arg0) {
    return new GlideOptions().error(arg0);
  }
   ...
   */
  public static GlideOptions overrideOf(int arg0, int arg1) {
   ...
   */
  public static GlideOptions overrideOf(int arg0) {
   ...
   */
  public static GlideOptions frameOf(long arg0) {
   ...
   */
  public static GlideOptions timeoutOf(int arg0) {
   ...
   */
  public static GlideOptions encodeQualityOf(int arg0) {
  ...
  @Override
  public GlideOptions sizeMultiplier(float arg0) {
  ...
  @Override
  public GlideOptions placeholder(int arg0) {
    return (GlideOptions) super.placeholder(arg0);
  }

  @Override
  public GlideOptions fallback(Drawable arg0) {
    return (GlideOptions) super.fallback(arg0);
  }

  @Override
  public GlideOptions fallback(int arg0) {
    return (GlideOptions) super.fallback(arg0);
  }
  ...
  @Override
  public GlideOptions error(int arg0) {
    return (GlideOptions) super.error(arg0);
  }

  @Override
  public GlideOptions theme(Resources.Theme arg0) {
  ...
  @Override
  public GlideOptions encodeQuality(int arg0) {
    return (GlideOptions) super.encodeQuality(arg0);
  }

  @Override
  public GlideOptions frame(long arg0) {
  ...
  @Override
  public GlideOptions timeout(int arg0) {
  ...
  @Override
  public GlideOptions optionalTransform(Transformation<Bitmap> arg0) {
    return (GlideOptions) super.optionalTransform(arg0);
  }

  @Override
  public <T> GlideOptions optionalTransform(Class<T> arg0, Transformation<T> arg1) {
    return (GlideOptions) super.optionalTransform(arg0, arg1);
  }

  @Override
  public <T> GlideOptions transform(Class<T> arg0, Transformation<T> arg1) {
  ...
  @Override
  public GlideOptions apply(RequestOptions arg0) {
