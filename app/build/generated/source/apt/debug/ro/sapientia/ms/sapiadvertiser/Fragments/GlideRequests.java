...
public final class GlideRequests extends RequestManager {
  ...
  @Override
  public GlideRequest<Drawable> load(Bitmap arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }

  @Override
  public GlideRequest<Drawable> load(Drawable arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }

  @Override
  public GlideRequest<Drawable> load(String arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }

  @Override
  public GlideRequest<Drawable> load(Uri arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }

  @Override
  public GlideRequest<Drawable> load(File arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }

  @Override
  public GlideRequest<Drawable> load(Integer arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }

  @Override
  public GlideRequest<Drawable> load(URL arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }

  @Override
  public GlideRequest<Drawable> load(byte[] arg0) {
    return (GlideRequest<Drawable>) super.load(arg0);
  }
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof ro.sapientia.ms.sapiadvertiser.Fragments.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new ro.sapientia.ms.sapiadvertiser.Fragments.GlideOptions().apply(toSet));
    }
  }
}
